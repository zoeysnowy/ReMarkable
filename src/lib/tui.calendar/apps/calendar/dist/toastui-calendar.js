...
const MONTH_EVENT_HEIGHT = 17; // 🔧 ReMarkable: 修改为17px以实现紧凑布局
...
const WEEK_EVENT_HEIGHT = 17; // 🔧 ReMarkable: 修改为17px以实现紧凑布局
...
class EventUIModel {
  top = 0; // If it is one of duplicate events, represents the left value of a group of duplicate events.

  left = 0; // If it is one of duplicate events, represents the width value of a group of duplicate events.
...
function createDndDispatchers(set) {
  return {
    ...
    setDraggingEventUIModel: eventUIModel => {
      set(immer_esm(state => {
        state.dnd.draggingEventUIModel = (eventUIModel === null || eventUIModel === void 0 ? void 0 : eventUIModel.clone()) ?? null;
      }));
    }
  };
}
  ...
  return {
    ...
    updateDayGridRowHeightByDiff: _ref2 => {
      ...
      return set(immer_esm(state => {
        ...
        const height = ((_state$weekViewLayout = state.weekViewLayout.dayGridRows) === null || _state$weekViewLayout === void 0 ? void 0 : (_state$weekViewLayout2 = _state$weekViewLayout[rowName]) === null || _state$weekViewLayout2 === void 0 ? void 0 : _state$weekViewLayout2.height) ?? DEFAULT_PANEL_HEIGHT;
        state.weekViewLayout.dayGridRows[rowName] = {
          height: height + diff
        };
...
const primaryTimezoneSelector = state => {
  var _state$options, _state$options$timezo, _state$options$timezo2, _state$options$timezo3;

  return ((_state$options = state.options) === null || _state$options === void 0 ? void 0 : (_state$options$timezo = _state$options.timezone) === null || _state$options$timezo === void 0 ? void 0 : (_state$options$timezo2 = _state$options$timezo.zones) === null || _state$options$timezo2 === void 0 ? void 0 : (_state$options$timezo3 = _state$options$timezo2[0]) === null || _state$options$timezo3 === void 0 ? void 0 : _state$options$timezo3.timezoneName) ?? 'Local';
};
...
function week_findByDateRange(calendarData, condition) {
  ...
  const hourStart = (options === null || options === void 0 ? void 0 : options.hourStart) ?? 0;
  const hourEnd = (options === null || options === void 0 ? void 0 : options.hourEnd) ?? 24;
  const filterFn = Collection.and(...[getEventInDateRangeFilter(start, end)].concat(andFilters));
...
const EVENT_HEIGHT = 17; // 🔧 ReMarkable: 修改为17px以实现紧凑布局
...
function useCalendarColor(model) {
  const calendar = useCalendarById((model === null || model === void 0 ? void 0 : model.calendarId) ?? null);
  return F(() => ({
...
function useGridSelection(_ref) {
  ...
  const onMouseUp = (e, isClickEvent) => {
    ...
    if (isPresent(gridSelectionRef.current)) {
      ...
      const gridSelectionElements = Array.from((layoutContainer === null || layoutContainer === void 0 ? void 0 : layoutContainer.querySelectorAll(gridSelectionSelector)) ?? []);
...
function EventDetailSectionDetail(_ref) {
  ...
  return h("div", {
    ...
    className: eventDetailSectionDetail_classNames.content
  }, (calendar === null || calendar === void 0 ? void 0 : calendar.name) ?? '')), body && h("div", {
...
const useFloatingLayer = floatingLayerType => {
  ...
  return (floatingLayers === null || floatingLayers === void 0 ? void 0 : floatingLayers[floatingLayerType]) ?? null;
};
...
function Layout(_ref) {
  ...
  const layoutClassName = F(() => `${cls('layout')} ${className}`, [className]);
  hooks_module_h(() => {
    if (container) {
...
function NowIndicator(_ref) {
  ...
  hooks_module_(() => {
    const scrollToNow = behavior => {
      const scrollArea = (layoutContainer === null || layoutContainer === void 0 ? void 0 : layoutContainer.querySelector(`.${cls('panel')}.${cls('time')}`)) ?? null;
...
function NowIndicatorLabel(_ref) {
  ...
  }, `[${dateDifference > 0 ? '+' : '-'}${Math.abs(dateDifference)}]`), h(Template, {
...
function TimeGrid(_ref) {
  ...
  hooks_module_h(() => {
    if (isMounted()) {
      if (((currentDateData === null || currentDateData === void 0 ? void 0 : currentDateData.currentDateIndex) ?? -1) >= 0) {
...
function TimezoneLabels(_ref2) {
  ...
  }, !timezonesCollapsed && subTimezones.map((subTimezone, index) => h(TimezoneLabel, _extends({
    key: `subTimezone-${subTimezone.label ?? subTimezone.offset}`,
    width: timezoneLabelWidth,
    left: timezoneLabelWidth * index
  }, subTimezone))), showTimezoneCollapseButton && h(TimezoneCollapseButton, {
...
function day_Day() {
  ...
  const dayNames = getDayNames(days, ((_options$week = options.week) === null || _options$week === void 0 ? void 0 : _options$week.dayNames) ?? []);
  const {
    rowStyleInfo,
    cellWidthMap
...
function useDayGridMonthEventMove(_ref) {
  ...
  const movingEventUIModel = F(() => {
    ...
    if (movingEvent && (currentGridPos === null || currentGridPos === void 0 ? void 0 : currentGridPos.rowIndex) === rowIndex) {
      ...
      shadowEventUIModel.left = rowInfo[(currentGridPos === null || currentGridPos === void 0 ? void 0 : currentGridPos.columnIndex) ?? 0].left;
      shadowEventUIModel.width = rowInfo[(currentGridPos === null || currentGridPos === void 0 ? void 0 : currentGridPos.columnIndex) ?? 0].width;
    }
...
function Week() {
  ...
  const dayNames = getDayNames(weekDates, ((_options$week = options.week) === null || _options$week === void 0 ? void 0 : _options$week.dayNames) ?? []);
  const {
    rowStyleInfo,
    cellWidthMap
...
class CalendarCore {
  ...
  constructor(container) {
    ...
    this.container = isString_default()(container) ? ((_document = document) === null || _document === void 0 ? void 0 : _document.querySelector(container)) ?? null : container;
  ...
  getEvent(eventId, calendarId) {
    var _this$getEventModel;

    return ((_this$getEventModel = this.getEventModel(eventId, calendarId)) === null || _this$getEventModel === void 0 ? void 0 : _this$getEventModel.toEventObject()) ?? null;
  }
  /**
   * Update an event.
   *
