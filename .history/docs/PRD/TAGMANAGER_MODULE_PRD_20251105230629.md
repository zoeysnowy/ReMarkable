...
| 功能 | 文件 | 行号 | 关键函数/状态 |
|------|------|------|---------------|
| **批量操作 - 复制** | `TagManager.tsx` | L300-358 | handleCopy() |
| **批量操作 - 剪切** | `TagManager.tsx` | L360-411 | handleCut() |
| **批量操作 - 粘贴** | `TagManager.tsx` | L547-798 | handlePaste() |
| **辅助 - 复制粘贴** | `TagManager.tsx` | L413-466 | handleCopyPaste() |
| **辅助 - 剪切粘贴** | `TagManager.tsx` | L468-545 | handleCutPaste() |
| **批量删除** | `TagManager.tsx` | L853-878 | 键盘事件处理 |
| **批量移动** | `TagManager.tsx` | L880-947 | 键盘事件处理 |
| **批量日历映射** | `TagManager.tsx` | L949-968 | 键盘事件处理 |
