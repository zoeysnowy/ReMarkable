...
| 功能模块 | v1 实现 | v2 升级 |
|---------|--------|--------|
| **布局结构** | 单栏表单布局 | 左右分栏（左侧元数据 40% + 右侧日志 60%） |
...
│  └─────────────────┘  │  ┌───────────────────────────────────┐  │
│                       │  │ 【Plan提示区域】                    │  │
│  ┌─────────────────┐  │  │ ☑ ⏰ 创建于12h前，距离ddl还有2h30min │  │
│  │【中 Section】    │  │  │ ☑ 🚩 创建于12h前，距离ddl还有2h30min │  │
│  │ 计划安排         │  │  └───────────────────────────────────┘  │
│  │ 👥 Zoey; Jenny  │  │                                         │
│  │ 📅 10:00→12:00  │  │  ┌───────────────────────────────────┐  │
│  │ 📍 静安嘉里...   │  │  │ 【关联区域】                        │  │
│  │ 来自●Outlook    │  │  │ 🔗 上级任务：Project Ace (5/7)     │  │
│  └─────────────────┘  │  └───────────────────────────────────┘  │
│                       │                                         │
│  ┌─────────────────┐  │  ┌───────────────────────────────────┐  │
│  │【下 Section】    │  │  │ 【Slate 编辑区】                   │  │
│  │ 实际进展         │  │  │                                    │  │
│  │ 🕐 10:00→12:00  │  │  │ ─────────────────────             │  │
│  │ 🕐 23:00→01:00  │  │  │ 2025-10-19 10:21:18               │  │
│  │ 总时长：3小时    │  │  │                                    │  │
│  │ 比计划多30min   │  │  │ 处理完了一些出差的logistics...     │  │
│  └─────────────────┘  │  │ 准备先一个提纲丢给GPT...           │  │
│                       │  │                                    │  │
│                       │  │ ─────────────────────             │  │
