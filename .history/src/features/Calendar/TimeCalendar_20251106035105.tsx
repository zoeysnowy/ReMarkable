      ...
      <div className={`time-calendar-container ${className}`} style={{ 
        ...
        <ToastUIReactCalendar
          ...
          template={{
            ...
            // 周视图：只显示日期，星期几由 CSS 通过 data-day 属性添加
            weekDayName(model: any) {
              ...
              // 添加 data-day 属性，CSS 会用它来显示星期几
              return `<span class="toastui-calendar-template-weekDayName ${todayClass}" data-day="${day}">${dateDisplay}</span>`;
            },
