        ...
        <ToastUIReactCalendar
          ...
          template={{
            ...
            weekDayName(model: any) {
              ...
              const dayName = dayNamesShort[day];
              ...
              // 两行显示：上方是星期几，下方是日期
              return `
                <div class="toastui-calendar-template-weekDayName ${todayClass}">
                  <div class="week-dayname-top">${dayName}</div>
                  <div class="week-dayname-date">${dateDisplay}</div>
                </div>
              `;
            },
