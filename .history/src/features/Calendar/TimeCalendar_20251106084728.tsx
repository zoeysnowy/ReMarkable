        ...
        <ToastUIReactCalendar
          ...
          template={{
            ...
            task(event: any) {
              ...
              // 添加参会人信息
              const attendeesCount = event.raw?.attendees?.length || 0;
              const attendeesDisplay = attendeesCount > 0 ? `<span style="margin-left: 4px; font-size: 0.85em;">👥 ${attendeesCount}</span>` : '';
