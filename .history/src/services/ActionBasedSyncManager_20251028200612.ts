...
export class ActionBasedSyncManager {
  ...
  private async fetchRemoteChanges() {
    try {
      ...
      console.log(`📊 [Sync] Deletion check completed: ${deletionCheckCount} events checked, ${deletionCandidateCount} pending, ${deletionConfirmedCount} confirmed deletions`);
      ...
      this.deletionCandidates.forEach((candidate, eventId) => {
        ...
        const timeSinceMissing = now - candidate.firstMissingTime;
