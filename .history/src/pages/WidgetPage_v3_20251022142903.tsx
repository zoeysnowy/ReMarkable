      ...
      {!isLocked && (
        <div
          ...
          style={{
            ...
            left: 0,
            right: 0, // 从左到右全宽
            height: '20px', // 临时增加到20px测试
            zIndex: 10000, // 提高到最高层级，高于调整大小手柄
            cursor: 'move',
            backgroundColor: 'rgba(255, 100, 100, 0.5)', // 改成红色，更明显
            ...
            borderBottom: '1px solid rgba(100, 150, 255, 0.4)'
          } as CustomCSSProperties}
          onMouseEnter={() => {
            console.log('🎯 Mouse entered drag bar');
            setShowControls(true);
          }}
          onMouseLeave={() => setShowControls(false)}
          onMouseDown={(e) => {
            console.log('🖱️ Mouse down on drag bar - Electron should handle dragging', e);
          }}
        >
          <span style={{
            fontSize: '10px',
