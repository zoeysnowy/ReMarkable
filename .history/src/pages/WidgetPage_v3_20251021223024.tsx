...
const WidgetPage_v3: React.FC = () => {
  ...
  useEffect(() => {
    const styleId = 'widget-dynamic-opacity';
    ...
    // 动态 CSS：让所有内部元素跟随 bgOpacity
    styleEl.textContent = `
      /* 日历内部元素跟随透明度 */
      .widget-mode-calendar .toastui-calendar-month-dayname,
      .widget-mode-calendar .toastui-calendar-week-dayname,
      .widget-mode-calendar .toastui-calendar-month-week-item {
        background-color: rgba(255, 255, 255, ${bgOpacity * 0.05}) !important;
        border-color: rgba(0, 0, 0, ${bgOpacity * 0.1}) !important;
      }

      .widget-mode-calendar .toastui-calendar-month-daygrid-cell,
      .widget-mode-calendar .toastui-calendar-timegrid-cell,
      .widget-mode-calendar .toastui-calendar-month-date {
        background-color: rgba(255, 255, 255, ${bgOpacity * 0.02}) !important;
        border-color: rgba(0, 0, 0, ${bgOpacity * 0.08}) !important;
      }

      /* Grid 线条 */
      .widget-mode-calendar .toastui-calendar-layout,
      .widget-mode-calendar .toastui-calendar-grid,
      .widget-mode-calendar .toastui-calendar-weekday-grid,
      .widget-mode-calendar .toastui-calendar-month-week,
      .widget-mode-calendar .toastui-calendar-daygrid {
        border-color: rgba(0, 0, 0, ${bgOpacity * 0.08}) !important;
      }

      /* 底部状态栏 */
      .widget-mode-calendar .toastui-calendar-footer,
      .widget-mode-calendar .toastui-calendar-time-guide {
        background-color: rgba(255, 255, 255, ${bgOpacity * 0.05}) !important;
        border-color: rgba(0, 0, 0, ${bgOpacity * 0.1}) !important;
      }

      /* 顶部工具栏 */
      .widget-mode-calendar .toastui-calendar-toolbar,
      .widget-mode-calendar .toastui-calendar-header {
        background-color: rgba(255, 255, 255, ${bgOpacity * 0.05}) !important;
        border-color: rgba(0, 0, 0, ${bgOpacity * 0.1}) !important;
      }
    `;
  ...
  const widgetStyle: React.CSSProperties = {
    width: '100vw',
    height: '100vh',
    backgroundColor: 'transparent', // 容器始终透明
    display: 'flex',
      ...
      >
        <TimeCalendar
          ...
          style={{ 
            ...
            backgroundColor: bgColorRgba, // 应用日历背景色和透明度
            backdropFilter: bgOpacity < 1 ? 'blur(10px)' : 'none', // 半透明时启用毛玻璃
          }}
        />
      </div>
    </div>
