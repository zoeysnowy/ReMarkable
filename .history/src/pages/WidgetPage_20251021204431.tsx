    ...
    <div style={{ 
      ...
      <div style={dragBarStyle}>
        <span style={{ 
          ...
          📅 日历组件
          {isLocked && <span style={{ fontSize: '11px', opacity: 0.8 }}>🔒</span>}
        </span>
        <div style={{ display: 'flex', gap: '8px' }}>
          ...
          <button
            ...
            style={{
              ...closeButtonStyle,
              background: isLocked ? 'rgba(255, 200, 100, 0.4)' : 'rgba(255, 255, 255, 0.2)',
            }}
            onMouseEnter={(e) => e.currentTarget.style.background = isLocked ? 'rgba(255, 200, 100, 0.5)' : 'rgba(255, 255, 255, 0.3)'}
            onMouseLeave={(e) => e.currentTarget.style.background = isLocked ? 'rgba(255, 200, 100, 0.4)' : 'rgba(255, 255, 255, 0.2)'}
