...
const WidgetPage_v3: React.FC = () => {
  ...
  const [microsoftService] = useState(() => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        className="resize-handle-bottom resize-handle-left resize-handle-right resize-handle-bottom-left resize-handle-bottom-right"
        >
