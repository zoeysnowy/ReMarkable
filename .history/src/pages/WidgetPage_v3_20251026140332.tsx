    ...
    >
      ...
      >
        ...
        <div 
          style={{
            flexShrink: 0,
            margin: '0 8px 12px 8px', // 🎯 左右 8px，底部 12px 间距
            pointerEvents: 'none', // 🎯 允许鼠标事件穿透到底部 resize handle
        ...
        >
          {/* StatusBar 实际内容 - 恢复 pointer-events */}
          <div
            style={{
              ...
              cursor: 'default',
              pointerEvents: 'auto' // 🎯 StatusBar 内容可以交互
            }}
          >
          ...
          </div> {/* StatusBar 内容容器闭合 */}
        </div> {/* StatusBar 外层容器闭合 */}
      </div> {/* 主要内容容器闭合 */}
    </div> {/* Widget 根容器闭合 */}
  );
};
