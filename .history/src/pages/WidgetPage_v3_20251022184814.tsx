...
const WidgetPage_v3: React.FC = () => {
  ...
  const handleDragEnd = useCallback(async () => {
    ...
    // 通知主进程拖动结束，重置目标尺寸
    if (window.electronAPI?.widgetDragEnd) {
      await window.electronAPI.widgetDragEnd();
    }
  }, []);
      ...
      {!isLocked && (
        ...
        >
          ...
          <span style={{
            ...
            WebkitAppRegion: 'no-drag' // 文字不参与拖动
          } as CustomCSSProperties}
          >
            ⋮⋮⋮
          </span>
