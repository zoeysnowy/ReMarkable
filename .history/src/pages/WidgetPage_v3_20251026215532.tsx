        ...
        <div
          ...
          style={{
            ...
            backgroundColor: showControls 
              ? `rgba(${parseInt(bgColor.slice(1,3), 16)}, ${parseInt(bgColor.slice(3,5), 16)}, ${parseInt(bgColor.slice(5,7), 16)}, ${Math.min(bgOpacity * 0.95, 0.95)})` // 🎯 hover 时稍微增加不透明度，但不超过 95%
              : `rgba(${parseInt(bgColor.slice(1,3), 16)}, ${parseInt(bgColor.slice(3,5), 16)}, ${parseInt(bgColor.slice(5,7), 16)}, ${bgOpacity * 0.8})`, // 🎯 正常状态：bgOpacity * 0.8
            ...
            boxShadow: showControls 
              ? `0 2px 8px rgba(${parseInt(bgColor.slice(1,3), 16)}, ${parseInt(bgColor.slice(3,5), 16)}, ${parseInt(bgColor.slice(5,7), 16)}, 0.3)` 
              : 'none',
            pointerEvents: 'auto'
          }}
          onMouseEnter={(e) => {
