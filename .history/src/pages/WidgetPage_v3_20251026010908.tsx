  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 📊 Widget 专属状态栏 - 与 TimeCalendar 统一样式 */}
        <div style={{
          position: 'absolute',
          bottom: 0, // 🎨 紧贴底部，与 TimeCalendar 的 statusbar 一致
          left: 0,
          right: 0,
          ...
          borderRadius: '0 0 20px 20px', // 🎨 只有底部圆角，与 TimeCalendar statusbar 一致
          border: 'none', // 🎨 无边框，与 TimeCalendar statusbar 在 Widget 模式下一致
          padding: '8px 12px', // 🎨 与 TimeCalendar statusbar 相同的内边距
          display: 'flex',
