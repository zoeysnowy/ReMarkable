  ...
  const dynamicStyles = useMemo(() => {
    ...
    return `
      ...
      .toastui-calendar-panel-allday {
        ...
        ${calendarSettings.allDayHeight ? `height: ${calendarSettings.allDayHeight}px !important;` : 'height: 24px !important;'}
      }
      ...
      .toastui-calendar-panel.toastui-calendar-task {
        ...
        ${calendarSettings.taskHeight ? `height: ${calendarSettings.taskHeight}px !important;` : 'height: 24px !important;'}
      }
      ...
      .toastui-calendar-panel.toastui-calendar-milestone {
        ...
        ${calendarSettings.milestoneHeight ? `height: ${calendarSettings.milestoneHeight}px !important;` : 'height: 24px !important;'}
      }
