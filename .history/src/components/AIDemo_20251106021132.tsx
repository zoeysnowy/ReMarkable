      ...
      <div className="ai-demo-container">
        ...
        {showConfig && (
          <div className="config-panel">
            ...
            <div className="config-group">
              ...
              <div className="radio-group">
                <label className="radio-label">
                  ...
                  />
                  <span>DashScope 云端（推荐）</span>
                  <span className="badge">免费额度 100万 tokens</span>
                </label>
                <label className="radio-label" style={{ opacity: 0.5, cursor: 'not-allowed' }}>
                  <input
                    type="radio"
                    value="hunyuan"
            ...
            {provider === 'hunyuan' && (
              <div className="config-group">
                <div className="help-text warning" style={{ marginBottom: '16px' }}>
                  <p>⚠️ <strong>重要提示：腾讯云 API 不支持浏览器直接调用</strong></p>
                  <p>由于 CORS 限制，腾讯混元 API 只能从服务器端调用。</p>
                  <p>💡 <strong>推荐使用 DashScope（阿里云）</strong>：</p>
                  <ul>
                    <li>✅ 支持浏览器直接调用</li>
                    <li>✅ 免费 100 万 tokens</li>
                    <li>✅ 同样优秀的中文能力</li>
                  </ul>
                </div>
