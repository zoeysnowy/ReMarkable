...
export const TiptapFreeFormEditor = <T,>({
  ...
  const handleLineEnter = useCallback((lineId: string) => {
    ...
    setTimeout(() => {
      const element = document.querySelector(`[data-line-id="${newLine.id}"] .tiptap-line-editor`) as HTMLElement;
      console.log('[TiptapFreeFormEditor] Found element:', element);
      if (element) {
        element.focus();
  ...
  const handleLineShiftEnter = useCallback((lineId: string) => {
    ...
    if (!isDescriptionMode) {
      ...
      setTimeout(() => {
        const element = document.querySelector(`[data-line-id="${descLine.id}"] .tiptap-line-editor`) as HTMLElement;
