    ...
    <div className="plan-manager">
      ...
      {replacingTagElement && (
        <Tippy
          ...
          offset={[0, 8]}
          appendTo={() => document.body}
                  dbg('picker', 'onTimeApplied from HeadlessFloatingToolbar', {
                    targetId: pickerTargetItemIdRef.current || currentFocusedLineId,
                    eventId: (items.find(i => i.id === (pickerTargetItemIdRef.current || currentFocusedLineId || '').replace('-desc',''))?.eventId) || undefined,
                  });
          theme="light"
          onClickOutside={() => {
              ...
              {existingTags.map((tag) => {
                ...
                return (
                  <div
                    ...
                    onClick={() => {
                      // 替换标签
                          dbg('picker', 'No existing eventId on picker apply; creating new event from current item HTML', {});
