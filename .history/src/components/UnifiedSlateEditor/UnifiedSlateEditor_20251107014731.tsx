...
export const UnifiedSlateEditor: React.FC<UnifiedSlateEditorProps> = ({
  ...
  React.useEffect(() => {
    ...
    console.log(`%c[🚀 ${timestamp}] UnifiedSlateEditor mounted with DEBUG LOGGING ENABLED`, 
    ...
    return () => {
      console.log(`%c[👋 ${new Date().toISOString().split('T')[1].slice(0, 12)}] UnifiedSlateEditor unmounted`, 
