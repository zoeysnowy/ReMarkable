          ...
          {tags
            ...
            >
                ...
                <div style={{
                  ...
                  <span 
                    ...
                    style={{ 
                      ...
                      whiteSpace: 'pre', // 🔧 保留空格，使整个区域可选
                      display: 'block', // 🔧 改为block，占满宽度
                      padding: '2px 8px',
                      cursor: 'text',
                      minHeight: '20px' // 🔧 确保有高度
                    }}
                    contentEditable
                    suppressContentEditableWarning
                    onBlur={(e) => {
                      const newName = (e.currentTarget.textContent || '').trim(); // 🔧 保存时去除空格
                      handleTagSave(tag.id, newName);
                    }}
                    onKeyDown={(e) => handleTagKeyDown(e, tag.id, tag.level || 0)}
                  >
                    {tag.name}{'\u00A0'.repeat(20)}{/* 🔧 添加不间断空格，扩大可选区域 */}
                  </span>
                </div>
              </div>
              ...
              <div style={{
                ...
                alignItems: 'center',
                gap: '20px',
                flex: '1', // 使用flex自适应，而不是固定的vw计算
                minWidth: '400px', // 最小宽度保证不挤压
