...
export const SlateLine: React.FC<SlateLineProps> = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* 🔍 [IME 调试] 第二轮二分：注释掉 onKeyDown, onCompositionStart/End 事件处理器 */}
        <Editable
