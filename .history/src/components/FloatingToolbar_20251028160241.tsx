    ...
    >
      <div className="floating-toolbar-content">
        ...
        <div className="toolbar-group">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              <path d="M8.5 5.5L3 11l5.5 5.5L10 15l-4-4 4-4-1.5-1.5zm7 0L21 11l-5.5 5.5L14 15l4-4-4-4 1.5-1.5z" />
            </svg>
          </button>
        </div>
        ...
        <div className="toolbar-group">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              <path d="M10.586 4.343a2 2 0 0 1 2.828 0l3.172 3.172a2 2 0 0 1 0 2.828l-1.414 1.414a1 1 0 0 1-1.414-1.414l1.414-1.414-3.172-3.172-1.414 1.414a1 1 0 1 1-1.414-1.414l1.414-1.414zm-3.172 7.071a2 2 0 0 1 2.828 0l1.414 1.414a1 1 0 0 1-1.414 1.414l-1.414-1.414-3.172 3.172 1.414 1.414a1 1 0 1 1-1.414 1.414l-1.414-1.414a2 2 0 0 1 0-2.828l3.172-3.172z" />
            </svg>
          </button>
