...
const PlanManager: React.FC<PlanManagerProps> = ({
  ...
  const [dateMentionPosition, setDateMentionPosition] = useState<{ x: number; y: number } | null>(null);
  ...
  return (
    <div className="plan-manager">
      ...
      {/* 日期提及弹窗 */}
      {showDateMention && dateMentionPosition && (
        <div
          style={{
            position: 'fixed',
            left: dateMentionPosition.x,
            top: dateMentionPosition.y,
            zIndex: 10000,
        ...
        >
          <DateMentionPicker
            ...
            onClose={() => setShowDateMention(false)}
          />
        </div>
      )}
      ...
      {showDateMention && (
        <div
          ...
          onClick={() => setShowDateMention(false)}
        />
      )}
    </div>
  );
