  ...
  return (
    <div
      ...
      style={{
        ...
        cursor: isLocked ? 'default' : 'default', // 移除整体的grab cursor
        userSelect: 'none',
      ...
      <div
        style={{
          ...
          background: showControls 
            ? 'linear-gradient(180deg, rgba(100,150,255,0.3) 0%, rgba(100,150,255,0.1) 100%)'
            : 'transparent',
          backdropFilter: showControls ? 'blur(5px)' : 'none',
          transition: 'background 0.2s ease, backdrop-filter 0.2s ease',
          borderRadius: '8px 8px 0 0'
        }}
        onMouseDown={handleDragStart}
        title={isLocked ? '已锁定' : '拖动移动组件'}
      />
      {/* 顶部拖动条 - 始终存在的10px拖动区域 */}
      <div
        style={{
      ...
      {showControls && (
        <div
          style={{
            ...
            pointerEvents: 'auto' // 允许控制栏内的元素交互
          }}
        >
          {/* 左侧：视图切换 */}
      ...
      {!isLocked && (
        <div
          style={{
            ...
            height: '20px',
            cursor: 'se-resize',
            background: 'linear-gradient(-45deg, transparent 50%, rgba(100,150,255,0.5) 50%)',
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.background = 'linear-gradient(-45deg, transparent 50%, rgba(100,150,255,0.8) 50%)';
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.background = 'linear-gradient(-45deg, transparent 50%, rgba(100,150,255,0.5) 50%)';
          }}
          title="拖动调整大小"
        />
      )}
