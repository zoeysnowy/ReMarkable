    ...
    <div className="plan-manager">
      ...
      <div className="plan-list">
        <div className="plan-list-header">
          <h2>📝 我的计划</h2>
          <button className="plan-add-btn" onClick={createNewItem}>+ 新建</button>
        </div>
        ...
        <div className="plan-items">
          ...
          {isCreatingNew && editingItem && (
            <div className="plan-item creating" style={{ borderLeft: '4px solid #007AFF' }}>
              <div className="plan-item-main">
                <span className="plan-item-icon">✨</span>
                <div
                  ref={(el) => { inputRefs.current[editingItem.id] = el; }}
                  className="plan-item-title"
                  contentEditable
                  suppressContentEditableWarning
                  onKeyDown={(e) => handleKeyDown(e, editingItem)}
                  data-placeholder="输入任务标题，按 Enter 创建..."
                />
              </div>
            </div>
          )}
