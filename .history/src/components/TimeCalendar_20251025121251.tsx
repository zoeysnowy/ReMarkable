...
export const TimeCalendar: React.FC<TimeCalendarProps> = ({
  ...
  useEffect(() => {
    ...
    styleElement.textContent = `
      ...
      .toastui-calendar-week-view-day-names .toastui-calendar-day-name {
      ...
      /* 全局边框覆盖 - 捕获所有可能的硬编码边框 */
      .toastui-calendar [class*="border"],
      .toastui-calendar [style*="border"] {
        border-color: ${getAdaptiveColors.borderLight} !important;
      }
      
      /* 时间网格小时标记 */
      .toastui-calendar-time .toastui-calendar-hour {
        border-top: 1px solid ${getAdaptiveColors.borderLight} !important;
      }
