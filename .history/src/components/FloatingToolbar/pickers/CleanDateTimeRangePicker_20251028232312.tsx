          ...
          onOpenChange={(open) => {
            ...
            if (open) {
              ...
              setTimeout(() => {
                ...
                console.log('📅 Found all dropdowns:', allDropdowns.length);
                
                allDropdowns.forEach((dropdown, index) => {
                  const element = dropdown as HTMLElement;
                  const styles = window.getComputedStyle(element);
                  
                  console.log(`📅 Dropdown ${index} before styling:`, {
                    element,
                  ...
                  element.classList.add('ant-slide-up-enter', 'ant-slide-up-enter-active');
                  
                  console.log(`📅 Dropdown ${index} after styling:`, {
