              ...
              setTimeout(() => {
                ...
                allDropdowns.forEach((dropdown, index) => {
                  ...
                  timeColumns.forEach((column) => {
                    ...
                    // 强制设置容器样式 - 精确计算的高度
                    col.style.height = '168px'; // 7项 × 24px
                    col.style.maxHeight = '168px';
                    col.style.minHeight = '168px';
                    ...
                    // 禁用自动滚动到选中项
                    const selectedCell = col.querySelector('.ant-picker-time-panel-cell-selected');
                    if (selectedCell) {
                      // 不要滚动到选中项，保持当前滚动位置
                      // selectedCell.scrollIntoView() 这个不调用
                    }
