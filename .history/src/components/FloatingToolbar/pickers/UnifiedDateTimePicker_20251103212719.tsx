...
import { dbg, warn } from '../../../utils/debugLogger';
...
const UnifiedDateTimePicker: React.FC<UnifiedDateTimePickerProps> = ({
  ...
  useEffect(() => {
    ...
    dbg('picker', 'TimeHub snapshot received for picker init', { eventId, start: eventTime.start, end: eventTime.end, loading: eventTime.loading });
    if (start) {
  ...
  useEffect(() => {
    ...
    const end = initialEnd
      ...
      : start;
    dbg('picker', 'Using initialStart/initialEnd to seed picker', { eventId, initialStart, initialEnd });
    ...
    if (selectedDates.start) {
      ...
      if (useTimeHub && eventId) {
        ...
        try {
          ...
          dbg('picker', 'Applying picker selection via TimeHub.setEventTime', { eventId, startIso, endIso, allDaySelected });
          ...
          dbg('picker', 'TimeHub.setEventTime resolved OK', { eventId });
        ...
        dbg('picker', 'Applying picker selection via onSelect (legacy/non-TimeHub)', { startStr, endStr });
