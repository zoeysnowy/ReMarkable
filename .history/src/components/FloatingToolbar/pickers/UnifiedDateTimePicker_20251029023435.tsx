...
const TimeColumn: React.FC<{
  ...
  return (
    <div className={`time-column ${disabled ? 'disabled' : ''}`} onClick={handleColumnClick}>
...
const TimeSelector: React.FC<{
  ...
  return (
    <div className={`time-selector ${disabled ? 'disabled' : ''}`} onClick={handleSelectorClick}>
  ...
  return (
    <div ref={containerRef} className="unified-datetime-picker" onClick={handleContainerClick}>
      ...
      <div className="main-content">
        ...
        {/* 右侧时间选择 */}
        <div className="time-section" onClick={(e) => e.stopPropagation()}>
          {/* 时间显示区域 */}
          {renderTimeDisplay()}
          
          <div className="time-selectors" onClick={(e) => e.stopPropagation()}>
            <TimeSelector
              value={startTime}
