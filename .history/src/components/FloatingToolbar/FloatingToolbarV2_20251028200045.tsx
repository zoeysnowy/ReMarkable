...
import { FloatingToolbarProps, ToolbarFeatureType } from './types';
import { TagPicker } from './pickers/TagPicker';
import { EmojiPickerPanel } from './pickers/EmojiPickerPanel';
  ...
  const renderQuickActionButton = (feature: ToolbarFeatureType) => {
    ...
    return (
      <button
        ...
        onClick={() => setActivePicker(activePicker === feature ? null : feature)}
      >
        {actionConfig.icon}
      </button>
    );
