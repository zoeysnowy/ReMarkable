...
import TippyDateRangePicker from './pickers/TippyDateRangePicker';
    ...
    if (feature === 'dateRange') {
      return (
        <Tippy
          ...
          appendTo="parent"
          zIndex={99999}
          onCreate={(instance) => console.log('📅 Tippy created:', instance)}
          onShow={(instance) => console.log('📅 Tippy showing:', instance)}
          onMount={(instance) => console.log('📅 Tippy mounted:', instance)}
        >
        >
          <button
            className={`headless-toolbar-btn headless-toolbar-action-btn ${
