        ...
        <div className="settings-content">
          ...
          {isWidgetMode && (
            <>
              ...
              <div className="settings-section compact-section">
                <div className="compact-slider-row">
                  <span className="slider-label">🔒 锁定位置</span>
                  <label 
                    style={{
                      display: 'flex',
                      alignItems: 'center',
                    ...
                    onClick={(e) => {
                      e.stopPropagation();
                      console.log('🖱️ Lock label clicked');
                    }}
                  >
                    <input
                      type="checkbox"
                      ...
                      onChange={(e) => {
                        e.stopPropagation();
                        console.log('🔄 Lock checkbox changed:', e.target.checked);
                        onWidgetLockToggle?.(e.target.checked);
                      }}
                      onClick={(e) => {
                        e.stopPropagation();
                        console.log('🖱️ Lock checkbox clicked');
                      }}
                      style={{
                        width: '18px',
                        height: '18px',
