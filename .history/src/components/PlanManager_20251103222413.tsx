          ...
          (async () => {
            try {
              if (updatedItem.eventId) {
                // 已有 Event：先通过 TimeHub 更新时间（如果 Picker 已写入则跳过），再更新其它字段
                dbg('picker', '📝 更新现有 Event', { eventId: updatedItem.eventId, startIso, endIso });
                ...
                dbg('picker', '✅ Event 更新成功', { eventId: updatedItem.eventId });
              } else if (startIso) {
