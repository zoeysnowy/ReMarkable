  ...
  const handleConfirm = useCallback(async () => {
    ...
    if (useTimeHub && eventId && spec) {
      try {
        ...
        dbg('mention', 'Writing fuzzy time to TimeHub from DateMentionPicker', { eventId, spec });
    ...
    dbg('mention', 'Confirm DateMentionPicker selection and bubble up', {
      start: parsedDate.start?.toISOString?.(),
      end: parsedDate.end?.toISOString?.(),
      rawText: input,
    });
