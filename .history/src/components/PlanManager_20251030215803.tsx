...
const PlanManager: React.FC<PlanManagerProps> = ({
  ...
  const renderLineSuffix = (line: FreeFormLine<PlanItem>) => {
    ...
    if (item.tags && item.tags.length > 0) {
      console.log('🏷️ [renderLineSuffix] Item tags:', item.id, item.tags);
    }
    ...
    <div className="plan-manager">
      ...
      <HeadlessFloatingToolbar
        ...
        onTagSelect={(tagIds: string[]) => {
          console.log('🏷️ [PlanManager] onTagSelect called:', { tagIds, currentFocusedLineId });
          ...
          if (currentFocusedLineId) {
            ...
            console.log('🏷️ [PlanManager] Found item:', item);
            ...
            if (item) {
              ...
              console.log('🏷️ [PlanManager] Tag names:', tagNames);
              ...
              console.log('🏷️ [PlanManager] Saving updated item:', updatedItem);
              onSave(updatedItem);
            }
          } else {
            console.warn('⚠️ [PlanManager] No focused line ID');
          }
        }}
