    ...
    >
      ...
      >
        ...
        >
            ...
            {(['month', 'week', 'day'] as const).map(view => (
              <button
                ...
                style={{
                  padding: '4px 10px',
                  fontSize: '11px',
                  backgroundColor: settings.view === view ? 'rgba(255,255,255,0.4)' : 'rgba(255,255,255,0.15)',
                  color: 'white',
                  border: settings.view === view ? '1px solid rgba(255,255,255,0.6)' : '1px solid rgba(255,255,255,0.2)',
                  borderRadius: '4px',
                  cursor: 'pointer',
          ...
          {/* 同步按钮 */}
          <button
            onClick={() => syncManager?.performSync()}
            style={{
              padding: '4px 10px',
              fontSize: '14px',
          ...
          <button
            onClick={() => handleSelectDateTime({ 
              ...
              end: { toDate: () => new Date(Date.now() + 3600000) },
              isAllday: false 
            })}
            style={{
              padding: '4px 10px',
