...
export const TimeCalendar: React.FC<TimeCalendarProps> = ({
  ...
  useEffect(() => {
    ...
    styleElement.textContent = `
      ...
      /* 控制栏背景 - 与日历主体统一的自适应背景 */
      .toastui-calendar-controls,
      .toastui-calendar-controls[style*="background"] {
        ...
        border: 1px solid ${getAdaptiveColors.borderMedium} !important;
        border-bottom: 1px solid ${getAdaptiveColors.borderMedium} !important;
      }
    ...
    <>
      ...
      <div className={`time-calendar-container ${className}`} style={{ 
        ...
        <div style={{ 
          ...
          border: isWidgetMode ? `2px solid ${calendarBackgroundColor}` : 'none', // 🎨 Widget 模式添加边框
        ...
        <div style={{
          ...
          padding: '8px 12px',
          background: bgRgba,
          borderRadius: isWidgetMode ? '0 0 20px 20px' : '4px', // 🎨 Widget 模式底部圆角
          border: isWidgetMode ? 'none' : `1px solid ${getAdaptiveColors.borderMedium}`, // 🎨 自适应边框
          fontSize: '12px',
